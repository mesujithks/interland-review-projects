 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://webservice.javapostsforlearning.arpit.org/", wsdlLocation = "http://localhost:8090/HelloWorldWS/HelloWorldWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/HelloWorldWS/HelloWorldWS?wsdl");

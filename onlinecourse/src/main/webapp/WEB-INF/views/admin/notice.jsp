        ...
        <div class="row">
        	...
        	<div class="col-sm-4">
	        	<div class="input-group" id="search_block">
					...
					<input id="customSearchBox" type="text" class="form-control" name="search" placeholder="Search" required> &nbsp;&nbsp; &nbsp;
					<input type="submit" class="btn btn-primary btn-md btn-success" id="customSearchBoxBtn" value="Search">
				</div>
        	</div>
        	<div class="col-sm-4" align="right">
        		<a class="btn btn-primary btn-sm" href="AddNotice">ADD</a>
        	</div>
        </div>
        <br />
        <!-- -->
		    ...
		    <div class="modal-dialog modal-sm">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		          <p id="modal-msg">Are you sure want to delete the Notice?</p>
		        </div>

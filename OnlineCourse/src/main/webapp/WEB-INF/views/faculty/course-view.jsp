...
<div class="content container" id="wrapper">
        ...
        <div class="row">
        	...
        	<div class="col-sm-4" align="right">
        		<a class="btn btn-primary btn-sm" href="AddContent?id=${courseId}">ADD CONTENT</a>
        		<a class="btn btn-primary btn-sm btn-success" href="Students?id=${courseId}">VIEW STUDENTS</a>
        	</div>
        </div>
        <br />
        <!-- -->

...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/all-notice-faculty.js"></script>
...
<h3><a class="activer" align="center"
 ...
 <a   href="${pageContext.request.contextPath}/faculty/index">All Courses</a>
  ...
  <a class="active" href="${pageContext.request.contextPath}/faculty/Notice">Notice</a>
...
<div class="content container" id="wrapper">
        ...
        <h1 class="mt-4">Notice Details</h1>
        <div class="row">
        	<div class="col-sm-4">
        	</div>
        	<div class="col-sm-4">

...
<body class="text-center">
	...
	<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
		...
		<br />
		<br />
		<h1 class="cover-heading">Online Course Portal</h1>
		<c:if test="${result != null}">
			<h2>${result["message"]}</h2>
			</script>

		</c:if>
		<p class="lead"> This project aims at creating a Courses portal for a campus/organization. This allows registered users of the system to join a course available in the site and access the materials published for the course. People can register themselves as students of a course or Faculty for a course.
</p>
		<p class="lead">

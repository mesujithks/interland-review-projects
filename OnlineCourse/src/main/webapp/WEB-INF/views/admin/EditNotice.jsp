...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/bootstrap.min.css">
	  	<script src="${pageContext.request.contextPath}/resources/js/editNotice.js"></script>
...
<h3><a class="activer" align="center"
 ...
 <a  href="${pageContext.request.contextPath}/admin/index">View Students</a>
  ...
  <a href="${pageContext.request.contextPath}/admin/ViewCourse">View Courses</a>
   <a  class="active" href="${pageContext.request.contextPath}/admin/Notice">Notice</a>
...
<div class="content container" id="wrapper">
        ...
        <div class="row">
        	...
        	<form id="edit_form" class="form-horizontal" action='EditNoticeForm' method="post">
  				<fieldset>
  				<div class="form-group">
						<input type="hidden" class="form-control" name="noticeId"  value="${notice.noticeId}" required="required">		
					</div>
					
  				
  					<div class="form-group">
						<input type="text" class="form-control" name="title" placeholder="Title" value="${notice.title}" required="required">		
					</div>
					
						<div class="form-group">
							<input type="text" class="form-control" name="content" placeholder="Content" value="${notice.content}" required="required">		
						</div>

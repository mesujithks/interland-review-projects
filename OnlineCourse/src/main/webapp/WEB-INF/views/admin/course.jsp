...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/course.js"></script>
...
<div class="content container" id="wrapper">
        ...
        <div class="row">
        	...
        	<div class="col-sm-4" align="right">
        		<a class="btn btn-primary btn-sm" href="AddCourse">ADD COURSE</a>
        	</div>
        </div>
        <br />
        <!-- -->
		    ...
		    <div class="modal-dialog modal-sm">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		          <p id="modal-msg">Are you sure want to delete the Course?</p>
		        </div>

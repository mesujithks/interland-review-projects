...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/bootstrap.min.css">
	  	<script src="${pageContext.request.contextPath}/resources/js/editCourse.js"></script>
...
<div class="content container" id="wrapper">
        ...
        <div class="row">
        	...
        	<form id="edit_form" class="form-horizontal" action='AddCourseForm' method="post">
  				<fieldset>
  					<div class="form-group">
						<input type="hidden" class="form-control" name="courseId" placeholder="Course Name" value="${course.courseId}" required="required">		
					</div>
  					<div class="form-group">
						<input type="text" class="form-control" name="courseName" placeholder="Course Name" value="${course.courseName}" required="required">		
					</div>
					
						<div class="form-group">
							<textarea class="form-control" name="shortD" placeholder="Description" required="required">${course.shortD}</textarea>		
						</div>

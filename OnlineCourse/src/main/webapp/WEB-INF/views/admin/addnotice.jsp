...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/addNotice.js"></script>
...
<div class="content container" id="wrapper">
        ...
        <div class="row">
        	...
        	<form id="add_form" class="form-horizontal" action='AddNoticeForm' method="post">
  				<fieldset>
  					<div class="form-group">
						<input type="text" class="form-control" name="title" placeholder=" Notice Title " required="required">		
					</div>
					
						<div class="form-group">
							<textarea class="form-control" name="content" placeholder="Description" required="required"></textarea>		
						</div>

...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/all-notice-student.js"></script>
...
<h3><a class="activer" align="center"
 ...
 <a   href="${pageContext.request.contextPath}/student/index">All Courses</a>
  <a  href="${pageContext.request.contextPath}/student/MyCourses">My Courses</a>
  <a class="active" href="${pageContext.request.contextPath}/student/Notice">Notice</a>
...
<div class="content container" id="wrapper">
        ...
        <br />
        <!-- -->
        <table id="notice" class="table table-striped table-bordered nowrap" style="width:100%">
 		<thead>
            <tr>
                <th>Title</th>
                <th>Content</th>
		    ...
		    <div class="modal-dialog modal-sm">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		          <p id="modal-msg">Are you sure want to delete the Student?</p>
		        </div>

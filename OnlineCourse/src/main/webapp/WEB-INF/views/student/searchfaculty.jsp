...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/searchfaculty.js"></script>
...
<h3><a class="activer" align="center"
 ...
 <a  href="${pageContext.request.contextPath}/student/index">All Courses</a>
  ...
  <a class="active"  href="${pageContext.request.contextPath}/student/searchfaculty">search faculty</a>
<a href="${pageContext.request.contextPath}/Logout">Logout</a>
</div>
 
<div class="content container" id="wrapper">

        <h1 class="mt-4" id="hd">Course Details</h1>
        <h2>Welcome ${id}</h2>
      	<div id="alerts"></div>
        <div class="row">
        	<div class="col-sm-4">

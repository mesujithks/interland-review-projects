...
<div class="content container" id="wrapper">
        <h1 class="mt-4">Edit Consumer</h1>
        <div class="row">
        	<div class="col-sm-4"></div>
        	<div class="col-sm-4" align="center">
        	<form id="add_form" class="form-horizontal" action='EditForm' method="post">
  				<fieldset>
				    ...
				    <br>
				    <input type="submit" class="btn btn-primary btn-lg btn-success" id="btn_add" value="SAVE">
  				</fieldset>
			</form>
          </div>
        </div>        

...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/display.js"></script>
...
<div class="sidebar">
  <a class="active" href="${pageContext.request.contextPath}/">View Consumers</a>
